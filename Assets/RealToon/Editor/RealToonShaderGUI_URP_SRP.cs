                    ...
                    if (ShowShadow)
                    {
                        ...
                        if (_N_F_SON.floatValue == 1)
                        {
                            ...
                            if (_N_F_SON.floatValue == 1)
                            {
                                ...
                                EditorGUILayout.TextArea("Add the 'SmoothObjectNormal - Helper' component to your object for this to work.\n\nTo Add:\nClick your object then click 'Add Component'\nthen 'RealToon>Tool>SmoothObjectNormal - Helper.", EditorStyles.label, GUILayout.ExpandWidth(true));
                                EditorGUI.EndDisabledGroup();
