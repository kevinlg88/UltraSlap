    ...
    public partial class RagdollProcessor
    {
        ...
        public class BonesChain
        {
            ...
            internal void InitializeForDummy(RagdollProcessor ragdollProcessor, Transform dummyRoot)
            {
                for (int b = 0; b < BoneSetups.Count; b++)
                {
                    ...
                    bone.SetPosingBone(FindChildByNameInDepth(bone.t.name, dummyRoot, true, null, ragdollProcessor.CheckFullBoneNamesWhenSearching ), ragdollProcessor);
        ...
        void Initialization(MonoBehaviour caller, Transform objectWithAnimator, Transform customRagdollAnimator = null, Transform rootBone = null)
        {
            ...
            if (customRagdollAnimator)
            {
                ...
                (
                FindChildByNameInDepth(Pelvis.name, customRagdollAnimator, true, null, CheckFullBoneNamesWhenSearching ),
                FindChildByNameInDepth(SpineStart.name, customRagdollAnimator, true, null, CheckFullBoneNamesWhenSearching ),
                FindChildByNameInDepth(Chest.name, customRagdollAnimator, true, null, CheckFullBoneNamesWhenSearching ),
                FindChildByNameInDepth(Head.name, customRagdollAnimator, true, null, CheckFullBoneNamesWhenSearching ),

                FindChildByNameInDepth(LeftUpperArm.name, customRagdollAnimator, true, null, CheckFullBoneNamesWhenSearching ),
                FindChildByNameInDepth(LeftForeArm.name, customRagdollAnimator, true, null, CheckFullBoneNamesWhenSearching ),
                FindChildByNameInDepth(RightUpperArm.name, customRagdollAnimator, true, null, CheckFullBoneNamesWhenSearching ),
                FindChildByNameInDepth(RightForeArm.name, customRagdollAnimator, true, null, CheckFullBoneNamesWhenSearching ),

                FindChildByNameInDepth(LeftUpperLeg.name, customRagdollAnimator, true, null, CheckFullBoneNamesWhenSearching ),
                FindChildByNameInDepth(LeftLowerLeg.name, customRagdollAnimator, true, null, CheckFullBoneNamesWhenSearching ),
                FindChildByNameInDepth(RightUpperLeg.name, customRagdollAnimator, true, null, CheckFullBoneNamesWhenSearching ),
                FindChildByNameInDepth(RightLowerLeg.name, customRagdollAnimator, true, null, CheckFullBoneNamesWhenSearching )
                );
                }
                else
                {
