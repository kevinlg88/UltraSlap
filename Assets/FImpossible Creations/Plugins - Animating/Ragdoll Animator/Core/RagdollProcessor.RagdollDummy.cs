    ...
    public partial class RagdollProcessor
    {
        ...
        private void PrepareRagdollDummy(Transform objectWithAnimator, Transform rootBone)
        {
            ...
            if (RagdollDummyBase == null)
            {
                ...
                Transform rootInParent = FindChildByNameInDepth(rootSkelBone.name, objectWithAnimator, true, null, CheckFullBoneNamesWhenSearching );
                ...
                PelvisInDummy = FindChildByNameInDepth(Pelvis.name, sTransform, true, null, CheckFullBoneNamesWhenSearching );
            ...
            if (BonesSetupMode == EBonesSetupMode.HumanoidLimbs)
            {
                ...
                for (int t = 0; t < toReAnimate.Count; t++)
                {
                    ...
                    Transform animBone = FindChildByNameInDepth(ragBone.name, objectWithAnimator.transform, true, null, CheckFullBoneNamesWhenSearching );
