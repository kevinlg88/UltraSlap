...
{
#if ENABLE_INPUT_SYSTEM && KAMGAM_UGUINAVIGATION_INPUT_SYSTEM
    public class InputDetector : IObserver<InputEventPtr>
#else
...
#endif
    {
        ...
        public static void AddCallback(System.Action<InputDevice> callback)
        {
            instance.OnInputDeviceChanged -= callback;
            instance.OnInputDeviceChanged += callback;
        }

        public static void RemoveCallback(System.Action<InputDetector.InputDevice> callback)
        {
            instance.OnInputDeviceChanged -= callback;
        }
        ...
        {
            var lastDevice = _lastInputDevice;
            ...
            if (lastDevice != _lastInputDevice)
            {
                OnInputDeviceChanged?.Invoke(_lastInputDevice);
            }
        ...
        static InputDetector instance
        {
            get
            {
                ...
                {
                    var go = new GameObject("InputDetector");
