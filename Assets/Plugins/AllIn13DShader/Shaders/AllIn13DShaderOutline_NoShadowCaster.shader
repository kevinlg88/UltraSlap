Shader "AllIn13DShader/AllIn13DShaderOutline_NoShadowCaster"
{
	Properties
	{
		...
		//Lighting
		[Effect(EffectID# LIGHTMODEL, GroupID# Lighting, IncompatibleWith# AFFECTED_BY_LIGHTMAPS)][KeywordEnum(None, Classic, Toon, ToonRamp, HalfLambert, FakeGI, FastLighting)] _LightModel ("Light Model", Float) = 1
    	...
    	//Specular
		[Effect(EffectID# SPECULARMODEL, GroupID# Lighting, DependentOn# LIGHTMODEL, IncompatibleWith# AFFECTED_BY_LIGHTMAPS)][KeywordEnum(None, Classic, Toon, Anisotropic, AnisotropicToon)]_SpecularModel ("Specular Model", Float) = 0
