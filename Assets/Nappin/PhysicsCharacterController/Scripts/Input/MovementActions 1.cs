...
//     version 1.7.0
//     from Assets/Nappin/PhysicsCharacterController/Scripts/Input/MovementActions 1.inputactions
//
...
public partial class @MovementActions1: IInputActionCollection2, IDisposable
{
    public InputActionAsset asset { get; }
    public @MovementActions1()
    {
        asset = InputActionAsset.FromJson(@"{
    ""name"": ""MovementActions 1"",
    ""maps"": [
        {
            ""name"": ""Gameplay"",
    ...
    {
        private @MovementActions1 m_Wrapper;
        public GameplayActions(@MovementActions1 wrapper) { m_Wrapper = wrapper; }
